...
![systemfont](7/ui-systemfont.png ) 
...
![ui-labelatlas](7/ui-labelatlas.png ) 
...
```cpp
class CC_DLL TextFieldTTF : public Label, public Indelicate
{
    //other 
}
```
...
**Caution: If the character you input can't be found in the TTF file when you have changed your TextFieldTTF to TTF type. It won't be displayed but the label do keep the character internally. Now if you delete the character, it seems nothing happen but the internal string indeed be deleted which is really weird.**
