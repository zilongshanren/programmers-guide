...
XXX: degrees, clock-wise, default value is 0
...
XXX: add 4 lines. Explain what is `Color3B`... what is 3B: three (RGB) Bytes (0-255)
XXX: mention that we have pre-defined colors, like Color3B::WHITE
XXX: Default value is 255,255,255 (WHITE)
...
XXX: It expects a Byte (0-255). Default value is 255 (non-opaque)
```cpp
