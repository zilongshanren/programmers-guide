...
![labelclass](6/ui-labelclass.png) 
...
As we know from the **Overview** part, the Label class is subclass from SpriteBatchNode. So we could treat each character like a Sprite. This means that each individual character can be:
...
![ui-label-bmfont](6/ui-labelbmfont.png ) 
...
![systemfont](6/ui-systemfont.png ) 
...
![ui-labelatlas](6/ui-labelatlas.png ) 
...
![ui-architecture](6/ui-architecture.png ) 
...
![ui-container](6/ui-container.png ) 
...
![scale9sprie](6/scale9sprite.png ) 
...
![ui-checkobx](6/ui-checkbox.png ) 

These five components are explained as below:

-  groundBoxNormal
![goundboxNormal](6/check_box_normal.png ) 

- groundBoxSelected
![grondboxselectd](6/check_box_normal_press.png ) 

- groundBoxDisabled
![groundboxdisabled](6/check_box_normal_disable.png)

- frontCrossNormal
![frontCrossNormal](6/check_box_active.png )

- frontCrossDisabled
![frontCrossDisabled](6/check_box_active_disable.png ) 
...
![loadingbar](6/ui-loadingbar.png ) 
...
![ui-imageview](6/ui-imageview.png ) 
...
![ui-textatlas](6/ui-textatlas.png ) 
...
![sample](6/ui-richtext-sample.png ) 
...
![ui-textfiled](6/ui-textfield.png ) 
...
![ui-scrollview](6/ui-scrollview.png ) 
