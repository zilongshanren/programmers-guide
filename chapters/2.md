...
![](2-web/in-order-walk.png "in-order walk")
...
![](2-web/2n_mainScene-sceneGraph.png "")
...
![](2-web/2n_main_sprites_nodes.png "")
...
![](2-web/2n_level1_action_start.png "")

If we set the position using `mySprite->setPosition(Vec2(500, 0));`:

![](2-web/2n_level1_action_end.png "")
...
![](2-web/2n_level1_action_end_rotation.png "")
...
![](2-web/2n_level1_action_end_scale.png "")
...
![](2-web/2n_level1_anchorpoint_0_0.png "") ![](2-web/smallSpacer.png "") ![](2-web/2n_level1_anchorpoint_05_05.png "") ![](2-web/smallSpacer.png "") ![](2-web/2n_level1_anchorpoint_1_1.png "")
