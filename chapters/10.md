...
![](10-web/lua_cocos_preferences.png)
...
![](10-web/lua_confirm_perspective.png)
![](10-web/lua_debug_dialog.png)

5.Use `Step over`, `Step into`, `Step out` in the tool bar to debug

![](10-web/lua_step_debug.png)
...
![](10-web/lua_config_button.png)

2. Select the `CocosLuaGame` item,then to configure
![](10-web/lua_debug_configure_dialog.png)
...
![](10-web/lua_configure_iOS_simulator.png)
...
5. Click 'Debug' button to begin to debug
  ...
  ![](10-web/lua_iOS_device_remote_setting.png)
...
![](10-web/lua_debug_android_adb_mode.png)
...
![](10-web/lua_anroid_device_remote_setting.png)
