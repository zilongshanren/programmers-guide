...
possible states the checkbox can be in.
...
```
In this example we created a `Slider`, gave it a skin and specified an event that
gets called as the slider is moved back and forth.
