...
`Director` controls the flow of operations and tells the necessary recipient what to do.
...
Keep this in consideration when ordering your elements! Also, you can add elements
in any order and they are automatically sorted based upon _z-order_.
...
0, 0 using  `mySprite->setAnchorPoint(Vec2(0, 0);` would result in the lower left
