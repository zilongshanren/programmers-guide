...
XXX: Rotate and scale should be here
...
### Easing
Easing is animating with a specified acceleration to make the animations smooth. A few
...
and complexity of adding it all for a few very basic actions. Another good example
