...
are both commercial and free tools available. Most 3D editors usually save files
in a common collection of formats for easy use within other editors as well as a
standard way for game engines to import you files for use.

* [3DS Max](http://www.autodesk.com/products/3ds-max/overview)
* [Blender](http://www.blender.org/)
* [Cinema4D](http://www.maxon.net/products/)
* [Maya](http://www.autodesk.com/products/maya/overview)
* [kHED](http://khed.glsl.ru/)
...
#### `fbx-conv`
Cocos2d-x provides a tool called `fbx-conv` that allows the conversion of an FBX
file into cocos2d-x proprietary formats. FBX is the most popular 3D file format
and is being supported by all the major editors.

## 3D File Formats
Cocos2d-x currently supports 2 3d file formats:

* [Wavefront Object](http://en.wikipedia.org/wiki/Wavefront_.obj_file) files:
`.obj` files
* Cocos2d-x 3d ad-hoc format:`c3t`, `c3b` files.

Cocos2d-x supports _Wavefront_ file format because it is widely adopted by the
3D editors, and it is extremely easy to parse. It is, however, limited and
doesn't support advanced features like animations.

On the other hand, `c3t` and `c3b` are Cocos2d-x proprietary file format that
